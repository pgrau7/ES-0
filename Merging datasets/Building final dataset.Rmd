...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
myvars <- c("country.x","year", "month","elec_id", "enep", "seats", "memag", "varmag", "EthAl", "uppertier")
myvars1 <- c("enep", "seats", "memag", "varmag", "EthAl", "uppertier")
...
newdata$upperseats <- as.numeric(mydata$upperseats)
