...
use "\\dcloud.local\public\023\u123827\Desktop\ClarkGolder2006\Legislative_new1.dta", clear
*Add ALESINA

merge m:m country using "\\dcloud.local\public\023\u123827\Desktop\ClarkGolder2006\alesina.dta"
...
merge 1:m country year using "\\dcloud.local\public\023\u123827\Desktop\ClarkGolder2006\clea1.dta"
...
label var EthAl "effective number of ethnic groups  (Alesina)"
label var varmag "district magnitude variance (CLEA)"
label var sdmag "standard deviation of district magnitude (CLEA)"
label var memag "average district magnitude (CLEA)"
...
correlate avemag medmag memag
correlate avemag medmag memag if avemag~=1
...
generate uppertier_ethal = uppertier*EthAl
generate logmag_ethal = logmag*EthAl
...
regress enep1  EthAl logmag uppertier enpres proximity1 logmag_ethal uppertier_ethal   proximity1_enpres if nineties==1
